...
class QueryBuilderTest extends TestCase
{
    ...
    public function testWhereBetween()
    {
        ...
        $collection = DB::table('categories')
            ->whereBetween('created_at', ["2025-01-05 10:10:10", "2025-07-05 10:10:10"])
            ->get();
    ...
    public function testOrdering()
    {
        ...
        $collection = DB::table('products')->whereNotNull('id')
            ->orderBy('price', 'asc')->orderBy('name', 'asc')->get();
    ...
    public function testQueryBuilderRaw()
    {
        ...
        self::assertEquals(19_000_000, $collection[0]->min_price);
        self::assertEquals(22_000_000, $collection[0]->max_price);
    }
